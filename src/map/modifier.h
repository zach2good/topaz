...
enum class Mod
{
    ...
    RUNE_1    = 1001, // stores the type of RUNE active (0 if nothing).
    RUNE_2    = 1002, // stores the type of RUNE active (0 if nothing).
    RUNE_3    = 1003, // stores the type of RUNE active (0 if nothing).
    RUNE_DMG = 1004, // stores the base damage of the RUNE effect before reductions.
